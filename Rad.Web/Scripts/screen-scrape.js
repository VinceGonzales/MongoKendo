...
$("table#tablepress-388 tbody tr").each(function ($indx, $elem) {
    ...
    weapon.RoF = parseInt($(this).find("td.column-2").text());
    weapon.Magazine = parseInt($(this).find("td.column-3").text());
    weapon.ReloadTime = $(this).find("td.column-4").text();
    weapon.Range = $(this).find("td.column-5").text();
    weapons.push(weapon);
});

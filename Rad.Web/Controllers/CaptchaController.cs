...
namespace Rad.Web.Controllers
{
    public class CaptchaController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            response.Content = new StreamContent(oMemoryStream);
            response.Content.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue("image/png");
            response.Content.Headers.ContentLength = oMemoryStream.Length;
            response.Headers.AddCookies(new CookieHeaderValue[] { SetCaptchaCookie(sCaptchaText) });

            return response;
        }

        private string SetCaptchaText()
        {
            Random oRandom = new Random();
        ...
        private CookieHeaderValue SetCaptchaCookie(string captcha)
        {
            CookieHeaderValue cookie = new CookieHeaderValue("captcha-text", captcha);
